function txt = Speech_text_zh(m4AFilename)

global url_use
if isempty(url_use)==1
    api_id = 'G78EDupau5dh9j35l8xZGgiv'; % Replace the api key
    secret_key = 'GdcZdjaSN3viyhN8wN0neTolcmp1eyjG'; % Replace the secret key
